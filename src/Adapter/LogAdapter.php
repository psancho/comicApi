...
namespace Psancho\Comic\Adapter;
...
use Psancho\Comic\Adapter\LogAdapter\SourceFileLineFormatter;
use Psancho\Comic\Adapter\LogAdapter\SourceFileProcessor;
use Psancho\Comic\Model\Conf;
use Psancho\Comic\Model\Conf\Monolog as ConfMonolog;
